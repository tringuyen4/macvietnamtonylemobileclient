...
import { SmartTableKhoHangComponent } from './smart-table-kho-hang/smart-table-kho-hang.component';
...
const routes: Routes = [{
  ...
  children: [
    ...
    {
      path: 'smart-table-kho-hang',
      component: SmartTableKhoHangComponent,
    },
    {
